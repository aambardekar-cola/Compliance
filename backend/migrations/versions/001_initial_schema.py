...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("cfr_references", postgresql.JSONB(), server_default=sa.text("'[]'::jsonb")),
        sa.Column("agencies", postgresql.JSONB(), server_default=sa.text("'[]'::jsonb")),
    ...
    op.create_table(
        ...
        sa.Column("affected_code", postgresql.JSONB(), server_default=sa.text("'[]'::jsonb")),
        sa.Column("affected_components", postgresql.JSONB(), server_default=sa.text("'[]'::jsonb")),
    ...
    op.create_table(
        ...
        sa.Column("highlights", postgresql.JSONB(), server_default=sa.text("'[]'::jsonb")),
        sa.Column("sent_to", postgresql.JSONB(), server_default=sa.text("'[]'::jsonb")),
        sa.Column("sent_at", sa.DateTime(), nullable=True),
        sa.Column("created_at", sa.DateTime(), server_default=sa.text("now()"), nullable=False),
    )
